...
#(
    ...
    output logic ddr_rcv_clk_i_o,
    output logic ddr_rcv_clk_i_oe_o,
    input  logic ddr_rcv_clk_o_i,
    output logic ddr_rcv_clk_o_o,
    output logic ddr_rcv_clk_o_oe_o,
    input  logic ddr_i_0_i,
    output logic ddr_i_0_o,
    output logic ddr_i_0_oe_o,
    ...
    output logic ddr_i_1_o,
    output logic ddr_i_1_oe_o,
    input  logic gpio_7_i,
    output logic gpio_7_o,
    output logic gpio_7_oe_o,
    input  logic ddr_i_2_i,
    output logic ddr_i_2_o,
    output logic ddr_i_2_oe_o,
    input  logic gpio_8_i,
    output logic gpio_8_o,
    output logic gpio_8_oe_o,
    input  logic ddr_i_3_i,
    output logic ddr_i_3_o,
    output logic ddr_i_3_oe_o,
    input  logic gpio_9_i,
    output logic gpio_9_o,
    output logic gpio_9_oe_o,
    input  logic ddr_o_0_i,
    output logic ddr_o_0_o,
    output logic ddr_o_0_oe_o,
    input  logic gpio_10_i,
    output logic gpio_10_o,
    output logic gpio_10_oe_o,
    input  logic ddr_o_1_i,
    output logic ddr_o_1_o,
    output logic ddr_o_1_oe_o,
    input  logic gpio_11_i,
    output logic gpio_11_o,
    output logic gpio_11_oe_o,
    input  logic ddr_o_2_i,
    output logic ddr_o_2_o,
    output logic ddr_o_2_oe_o,
    input  logic gpio_12_i,
    output logic gpio_12_o,
    output logic gpio_12_oe_o,
    input  logic ddr_o_3_i,
    output logic ddr_o_3_o,
    output logic ddr_o_3_oe_o,
