...
# Serial Link
set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33}  [get_ports {ddr_i_0_io}] ;
set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS33}  [get_ports {ddr_i_1_io}] ; # [get_ports {gpio_io[1]}] ; # rpi_gpio_tri_io[11]
set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33}  [get_ports {ddr_i_2_io}] ; # [get_ports {gpio_io[2]}] ; # rpi_gpio_tri_io[5]
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS33} [get_ports {ddr_i_3_io}] ; # [get_ports {gpio_io[6]}] ; # rpi_gpio_tri_io[3]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {ddr_o_0_io}] ; # [get_ports {gpio_io[7]}] ; # rpi_gpio_tri_io[1]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33}  [get_ports {ddr_o_1_io}] ; # [get_ports {gpio_io[8]}] ; # rpi_gpio_tri_io[2]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33}  [get_ports {ddr_o_2_io}] ; # [get_ports {gpio_io[9]}] ; # rpi_gpio_tri_io[14]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33}  [get_ports {ddr_o_3_io}] ; # [get_ports {gpio_io[10]}] ; # rpi_gpio_tri_io[19]
