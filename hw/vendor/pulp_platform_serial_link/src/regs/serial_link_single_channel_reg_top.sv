...
module serial_link_single_channel_reg_top #(
  ...
  logic [5:0] tx_phy_clk_div_qs;
  logic [5:0] tx_phy_clk_div_wd;
  logic tx_phy_clk_div_we;
  logic [5:0] tx_phy_clk_start_qs;
  logic [5:0] tx_phy_clk_start_wd;
  logic tx_phy_clk_start_we;
  logic [5:0] tx_phy_clk_end_qs;
  logic [5:0] tx_phy_clk_end_wd;
  ...
  assign tx_phy_clk_div_wd = reg_wdata[5:0];

  assign tx_phy_clk_start_we = addr_hit[3] & reg_we & !reg_error;
  assign tx_phy_clk_start_wd = reg_wdata[5:0];

  assign tx_phy_clk_end_we = addr_hit[4] & reg_we & !reg_error;
  assign tx_phy_clk_end_wd = reg_wdata[5:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[2]: begin
        reg_rdata_next[5:0] = tx_phy_clk_div_qs;
      end

      addr_hit[3]: begin
        reg_rdata_next[5:0] = tx_phy_clk_start_qs;
      end

      addr_hit[4]: begin
        reg_rdata_next[5:0] = tx_phy_clk_end_qs;
      end
